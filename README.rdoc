...
* cross-domain requests 
  CORS was needed to support cross-domain requests. It's possible to setup Angular
to proxy requests to your rails app instead, if you like. For more info on CORS 
setup see https://github.com/cyu/rack-cors  or look in application.rb. 
...
angular app will be listening on localhost:9000 ; rails app on localhost:3000
